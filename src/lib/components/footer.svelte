<script lang="ts">
  ...
  function introAnimations() {
    ...
    const fullphonenuberAnimate = letterSlideIn(fullphonenuber, {
      delay: 6,
      initDelay: 150,
    });
    ...
    <svg
      ...
      ><g transform="matrix(1,0,0,1,-1.2121212121212466,-2.3818077474892334)"
        ><svg
          ...
          ><g
            id="tight-bounds"
            transform="matrix(1,0,0,1,0.2400000000000091,0.4721951219512164)"
            ><svg
              viewBox="0 0 395.52 135.05560975609754"
              height="135.05560975609754"
              width="395.52"
              ><g
                ><svg
                  viewBox="0 0 395.52 135.05560975609754"
                          ...
                          ><g
                            ><svg
                              ...
                              ><g transform="matrix(1,0,0,1,0,0)"
                                ><svg
                                  width="395.52"
                                  viewBox="1.6 -29.6 92.24000000000001 31.5"
                                  height="135.05560975609754"
